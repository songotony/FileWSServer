...
if (config.crypto == undefined)
	config.crypto = {};
if (config.crypto.algorithm == undefined || typeof config.crypto.algorithm != "string" || config.crypto.algorithm == "")
	config.crypto.algorithm = "aes256";
if (config.crypto.password == undefined || typeof config.crypto.password != "string" || config.crypto.password == "")
	config.crypto.password = "password";
